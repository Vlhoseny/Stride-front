...
function NoteBlockEditor({
    ...
    return (
        ...
        >
            {/* Type selector (appears on hover) */}
            <div className="absolute -left-9 top-1 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col gap-0.5">
...
export default function SimpleNotes() {
    ...
    return (
        <div className="flex gap-4 h-[calc(100vh-20rem)] min-h-[400px]">
            ...
            <div
                className="
          w-56 shrink-0 rounded-2xl overflow-hidden flex flex-col
        ...
        "
          ...
          "
              ...
              "
                    ...
                    {/* Blocks */}
                    <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3 ps-14 scrollbar-thin">
