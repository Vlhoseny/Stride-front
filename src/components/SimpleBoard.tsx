    ...
    return (
      ...
      "
        >
            ...
            <GripVertical className="absolute top-3 right-3 w-3.5 h-3.5 text-muted-foreground/30 group-hover:text-muted-foreground/60 transition-colors" />

            <h3 className="text-sm font-bold tracking-tight text-foreground mb-1 pr-5 stealth-blur">
                {project.name}
            </h3>
            <p className="text-[11px] text-muted-foreground/70 line-clamp-2 leading-relaxed mb-3 stealth-blur">
                {project.description}
            </p>
            ...
            {COLUMNS.map((col) => {
              ...
              `}
                        ...
                        <div className="flex flex-col gap-2.5 min-h-[120px]">
                            {items.length === 0 && (
                                <div className="flex items-center justify-center h-24 rounded-2xl border border-dashed border-foreground/[0.06] dark:border-white/[0.06]">
